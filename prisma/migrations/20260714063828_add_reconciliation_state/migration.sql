...
INSERT INTO "new_FilingDraft" ("businessStructure", "closingWealth", "createdAt", "currentStep", "filerType", "id", "incomeSources", "openingWealth", "readinessChecks", "reconciliationGap", "refundDue", "salaryPercentage", "status", "taxPayable", "taxYear", "updatedAt", "userId") SELECT "businessStructure", "closingWealth", "createdAt", "currentStep", "filerType", "id", "incomeSources", "openingWealth", "readinessChecks", "reconciliationGap", "refundDue", "salaryPercentage", "status", "taxPayable", "taxYear", "updatedAt", "userId" FROM "FilingDraft";
